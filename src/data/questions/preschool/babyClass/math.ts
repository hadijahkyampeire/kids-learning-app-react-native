...
export const babyClassMathQuestions: Question[] = [
  {
    _id: "bb-maths-1",
    level: "preSchool",
    subject: "math",
  ...
  },
  {
    ...
    class: "baby",
    topic: "Numbers & Counting (0-5)",
    text: "Which group has 4? 🍎🍎 or 🍎🍎🍎🍎",
    options: ["Second group", "First group", "Same"],
    correct: "Second group",
    feedback: { correct: "Yes! Second group has 4.", incorrect: "Count both groups carefully." }
  },
  // Shapes & Patterns
  {
    _id: "bb-maths-9",
  ...
  },
  {
    ...
    options: ["Second group", "First group", "Same"],
    correct: "Second group",
    feedback: { correct: "Yes! Three dogs is more than two.", incorrect: "Count each group of dogs." }
  },
  {
    _id: "bb-maths-22",
    level: "preSchool",
