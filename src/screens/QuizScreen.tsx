...
const Quiz: React.FC = () => {
  ...
  const filterByLevel: Question[] = level
    ? questionsData[level as keyof typeof questionsData]
    : [];

  const questions: Question[] = filterByLevel
  ...
  const handleAnswer = async (answer: string) => {
    ...
    await sound.loadAsync(
      isCorrect
        ? require('../assets/sounds/correct-sound.wav')
    ...
    setAnswers((prev) => [
      ...prev,
      { questionId: currentQuestion._id, selected: answer, isCorrect },
    ]);
  };
    ...
    >
      ...
      <View style={styles.content}>
        <Text style={styles.h1}>
          {capitalize(category)} Quiz for {capitalize(level)}
        </Text>
